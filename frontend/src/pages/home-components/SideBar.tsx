...
export default function SideBar() {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (window.innerWidth < 768) {
        setIsCollapsed(false); // On mobile, don't collapse sidebar
      }
    };
  ...
  return (
    <>
      ...
      >
        <div className="h-full flex flex-col overflow-y-auto bg-white dark:bg-gray-800 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
            ...
            <li>
              <div className="relative group">
                ...
                >
                  ...
                  {!isCollapsed && (
                    <>
                      ...
                      {item.badge !== undefined && (
                        <span className="ms-2 h-5 min-w-5 px-1.5 flex justify-center items-center text-xs font-medium text-white rounded-full bg-amber-500 dark:bg-amber-600">
                          {item.badge}
                        </span>
                      )}
                    </>
                  ...
                  {isCollapsed && (
                    <div className="absolute left-full ml-6 scale-0 group-hover:scale-100 transition-all rounded bg-gray-800 text-white text-sm py-1.5 px-3 whitespace-nowrap">
                      {item.label}
                      {item.badge !== undefined && (
                        ...
                        <li key={subIndex}>
                          ...
                          >
                            ...
                            {subItem.badge !== undefined && (
                              <span className="h-5 min-w-5 px-1.5 flex justify-center items-center text-xs font-medium text-white rounded-full bg-amber-500 dark:bg-amber-600">
                                {subItem.badge}
                              </span>
                            )}
                          </a>
