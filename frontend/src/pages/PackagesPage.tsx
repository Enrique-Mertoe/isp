            ...
            <div className="card p-0 mx-1">
                <div className="card-header hstack border-bottom">
                    <div className="vstack gap-2">
                        <h3 className="mb-0 text-amber-600">Packages
                        </h3>
                        <p>All packages available to clients including hotspot, PPPoE and Data Plan packages</p>
                    </div>
                    <div className="col-sm-auto col-12 mt-4 mt-sm-0">
                        <div className="hstack gap-2 justify-content-sm-end">
                            <a
                                ...
                                className="pe-2"><i
                                className="bi bi-plus-square-dotted"></i> </span><span>Create Package</span></a>
                ...
                <ul className="nav nav-tabs overflow-x px-10 border-0">
                    <li className="nav-item"><a href="#" className="nav-link hstack gap-2  active">All

                        <span className="w-5 p-1 h-5  aspect-square ms-2 bg-amber-400 text-white rounded">
                        0</span>
                    </a></li>
                    <li className="nav-item"><a href="#" className="nav-link hstack gap-2  active">PPOE

                        <span className="w-5 p-1 h-5  aspect-square ms-2 bg-amber-400 text-white rounded">
                        0</span>
                    </a></li>
                    <li className="nav-item"><a href="#" className="nav-link hstack gap-2  active">Hotsport

                        <span className="w-5 p-1 h-5  aspect-square ms-2 bg-amber-400 text-white rounded">
                        0</span>
                    </a></li>
                    <li className="nav-item"><a href="#" className="nav-link  hstack gap-2  active">Data plans

                        <span className="w-5 p-1 h-5  aspect-square bg-amber-400 ms-2 text-white rounded">
                        0</span>
                    </a></li>
                </ul>
